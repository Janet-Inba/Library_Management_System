                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblstudents.FullName,tblbooks.BookName,tblbooks.ISBNNumber,tblissuedbookdetails.IssuesDate,tblissuedbookdetails.DueDate, tblissuedbookdetails.ReturnDate,tblissuedbookdetails.id as rid from  tblissuedbookdetails join tblstudents on tblstudents.StudentId=tblissuedbookdetails.StudentId join tblbooks on tblbooks.id=tblissuedbookdetails.BookId order by tblissuedbookdetails.IssuesDate";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>">
												...
												<?php } else { ?> <button class="btn btn-primary"><i class="fa fa-edit "></i> View</button> <?php } ?>
